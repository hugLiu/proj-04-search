...
function ($) {
    ...
    var Typeahead = function (element, options) {
        ...
        this.$menu.width(this.$element.outerWidth());     //pengjian add，为了使下拉提示与input等宽
    ...
    Typeahead.prototype = {
        ...
        //  Handle AJAX source 
        //
        ajaxer: function () {         //=========== yuanquan update
            var that = this,
                query = that.$element.val();
            //if (query === that.query && query!="") {
            //    return that;
            //}
        ...
        listen: function () {
            this.$element.on('blur', $.proxy(this.blur, this))
                         .on('click', $.proxy(this.inputClick, this))  //yuanquan add
