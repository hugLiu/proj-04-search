    ...
    searchBarSerivce.getRecommandWords(function(words) {
        ...
        if (words.length > 0) {
            ...
            for (var i = 0; i < words.length; i++) {
                var result = "<li style='height:35px;'><a style='line-height:35px;' href='/webapp/searchResult?w=" + words[i].text + "' title='" + words[i].text + "'><p style='line-height:35px'>" + subString(words[i].text, 40, true) + "</p></a></li>";
...
var searchText = $.util.pageParams["w"] ? decodeURI($.util.pageParams["w"]) : "";
